# The LingCode Rust Extension API

This crate lets you write extensions for LingCode in Rust.
...
LingCode extensions are packaged as WebAssembly files. In your Cargo.toml, you'll
...
To run your extension in LingCode as you're developing it:
...
## Compatible LingCode versions

Extensions created using newer versions of the LingCode extension API won't be compatible with older versions of LingCode.

Here is the compatibility of the `zed_extension_api` with versions of LingCode:

| LingCode version | `zed_extension_api` version |
| ----------- | --------------------------- |
| `0.192.x`   | `0.0.1` - `0.6.0`           |
| `0.186.x`   | `0.0.1` - `0.5.0`           |
| `0.184.x`   | `0.0.1` - `0.4.0`           |
