        ...
        match status {
            ...
            client::Status::UpgradeRequired => {
                ...
                let label = match auto_updater.map(|auto_update| auto_update.read(cx).status()) {
                    Some(AutoUpdateStatus::Updated { .. }) => "Please restart LingCode to Collaborate",
                    Some(AutoUpdateStatus::Installing { .. })
                    | Some(AutoUpdateStatus::Downloading { .. })
                    | Some(AutoUpdateStatus::Checking) => "Updating...",
                    Some(AutoUpdateStatus::Idle)
                    | Some(AutoUpdateStatus::Errored { .. })
                    | None => "Please update LingCode to Collaborate",
                };
                            ...
                            move |_window, _cx| {
                                ...
                                h_flex()
                                    ...
                                    .when(!has_organization, |parent| {
                                        parent.child(PlanChip::new(plan.unwrap_or(Plan::Free)))
                                    })
                                    .into_any_element()
                            },
                            move |_, cx| {
                        ...
                        this.custom_entry(
                            move |_window, _cx| {
                                h_flex()
                                    ...
                                    .gap_1()
                                    .justify_between()
                                    .child(Label::new("Restart to update LingCode").color(Color::Accent))
                                    .child(
