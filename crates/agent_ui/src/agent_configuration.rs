    ...
    fn render_provider_configuration_section(
        ...
        v_flex()
            ...
            .child(self.render_section_title(
                "LLM Providers",
                "Add at least one provider to use AI-powered features with LingCode's native agent.",
    ...
    fn render_zed_plan_info(&self, plan: Option<Plan>, cx: &mut Context<Self>) -> impl IntoElement {
        if let Some(plan) = plan {
            ...
            let (plan_name, label_color, bg_color) = match plan {
                ...
                Plan::Pro => ("Pro", Color::Accent, pro_chip_bg),
                Plan::MaxPro => ("Max Pro", Color::Accent, pro_chip_bg),
            };
    ...
    fn render_context_servers_section(&mut self, cx: &mut Context<Self>) -> impl IntoElement {
        ...
        v_flex()
            ...
            .child(self.render_section_title(
                ...
                "All MCP servers connected directly or via a LingCode extension.",
