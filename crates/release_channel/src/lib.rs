...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "LingCode-Editor-Dev",
        ReleaseChannel::Nightly => "LingCode-Editor-Nightly",
        ReleaseChannel::Preview => "LingCode-Editor-Preview",
        ReleaseChannel::Stable => "LingCode-Editor-Stable",
    }
}
...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "LingCode Dev",
            ReleaseChannel::Nightly => "LingCode Nightly",
            ReleaseChannel::Preview => "LingCode Preview",
            ReleaseChannel::Stable => "LingCode",
        }
    }
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "dev.lingcode.LingCode-Dev",
            ReleaseChannel::Nightly => "dev.lingcode.LingCode-Nightly",
            ReleaseChannel::Preview => "dev.lingcode.LingCode-Preview",
            ReleaseChannel::Stable => "dev.lingcode.LingCode",
        }
    }
