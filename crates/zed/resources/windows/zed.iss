...
AppPublisher=LingCode
AppPublisherURL=https://lingcode.dev/
AppSupportURL=https://lingcode.dev/
AppUpdatesURL=https://lingcode.dev/
...
[Files]
Source: "{#ResourcesDir}\LingCode.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
; URI Scheme
Root: HKCU; Subkey: "Software\Classes\lingcode"; ValueType: "string"; ValueData: "URL:lingcode Protocol"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\lingcode"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCU; Subkey: "Software\Classes\lingcode\DefaultIcon"; ValueType: "string"; ValueData: "{app}\LingCode.exe,1"
Root: HKCU; Subkey: "Software\Classes\lingcode\shell\open\command"; ValueType: "string"; ValueData: """{app}\LingCode.exe"" ""%1"""
