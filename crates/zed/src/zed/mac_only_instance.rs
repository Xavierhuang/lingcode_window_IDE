...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "LingCode Editor Dev Instance Running",
        ReleaseChannel::Nightly => "LingCode Editor Nightly Instance Running",
        ReleaseChannel::Preview => "LingCode Editor Preview Instance Running",
        ReleaseChannel::Stable => "LingCode Editor Stable Instance Running",
    }
}
