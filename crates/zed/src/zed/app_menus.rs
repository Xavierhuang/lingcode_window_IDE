...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    let mut view_items = vec![
        ...
        MenuItem::action("Logcat Panel", lingcode_android::ToggleLogcat),
        MenuItem::separator(),
    ...
    vec![
        Menu {
            ...
            disabled: false,
            items: vec![
                MenuItem::action("About LingCode", zed_actions::About),
                ...
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide LingCode", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit LingCode", Quit),
            ],
        },
        Menu {
            name: "File".into(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("Run on Wear OS", lingcode_android::AndroidRunWear),
                MenuItem::separator(),
                ...
                MenuItem::action("Launch Wear OS Emulator", lingcode_android::AndroidStartWearEmulator),
                MenuItem::separator(),
                ...
                MenuItem::action("Debug: Forward JDWP", lingcode_android::AndroidDebugJdwp),
                MenuItem::separator(),
                MenuItem::action(
